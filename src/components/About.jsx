import profileImg from '../assets/My pic/m5.png';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="w-full">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              I enjoy creating real-world solutions by combining hardware and software 
              technologies. I'm skilled in JavaScript, React, Node.js, and embedded 
              systems like Arduino and ESP32.
            </p>
          </div>
        </div>
      </div>
